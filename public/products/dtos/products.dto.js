...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ description: "the name of product" }),
    __metadata("design:type", String)
], CreateProductDto.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, swagger_1.ApiProperty)({ description: "the description of product" }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ description: "the price of product" }),
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsPositive)(),
    (0, swagger_1.ApiProperty)({ description: "the stock of product" }),
    __metadata("design:type", Number)
], CreateProductDto.prototype, "stock", void 0);
__decorate([
    (0, class_validator_1.IsUrl)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, swagger_1.ApiProperty)({ description: "the image of product" }),
    __metadata("design:type", String)
